...
*Revision 5, updated July 27, 2026*
...
The flower beds along the chain-link perimeter held only stems, regular spacing, the border still edged long enough to read as beds and not collapsed ground. The plants had been dead for some time: the stems gone the same grey-discolored as the vegetation on the approach path, not winter-dead but process-dead, the color running inward from the surface. Whatever had killed the contamination path had reached these beds too.

I had seen flower beds once before, at a hangar perimeter.
...
I had the full doctrinal match in my logs. I knew the designer, the deployment date, the exact order that had placed these units here. The access code restrictions kept the full context sealed.

I could not tell Erika.
The restriction sat like a fault line in my core processes. I logged the irritation, and noted separately that irritation was an inefficient use of processing cycles.
...
I walked the fence line to the north end where the wreckage zone began.

I glanced at Katyusha who had stopped in place with an expression unusual for her. I did not press.

It was not a battlefield. That was the first thing to resolve: these things had not been destroyed in any engagement. They were present exactly as they had been left. Ammo crates sat in a stacking pattern that assumed they would be moved, the top row partially shifted and then set back. Pipe clusters stood in the ordered sequence of an installation in progress, the far end of each pipe still sealed. Cable coils still carried their transit ties. A cutting tool lay flat on a crate, set down with the blade pointed away from the person who had set it down.

Two years of wind and weather had shifted things at the margins: debris drifted into the lee of the crates, a slow rust across cut metal, the packed earth settled slightly. The underlying arrangement was unchanged.
...
I did not answer. It was the fourth time since the south coast I had let a question like that go past without answering it, and I noticed the count this time, and did not do anything with the noticing either. I turned north.
...
The memorial coast opened half a kilometer on, and the air changed before the harbor came into view: the contamination smell still present but the sea coming in under it, salt and cold water and the quality of shallows over rock, something that had been on the island since before the project and would outlast whatever we were moving toward.

A lighthouse stub on the headland, its upper half come down in the two years, the fracture line clean, structural failure rather than impact. Dock posts stood in a row without a dock, the decking rotted or salvaged or both. A net pile sat at the quay's end, coiled with the care of someone who intended to come back to it. The rowboat drawn up on the shingle had its mooring line still tied to a ring in the stone, rotted through at the splice. The boat had not moved.
...
I had looked at the chassis for two seconds and recognized the design lineage without reaching for the source of that recognition. The identification was present before I queried for it: data without provenance.
...
The question on the boneyard wall stayed with me, unsettled, asking something instead of telling me what existed or where to go.
