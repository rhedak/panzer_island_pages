...
The coastal path came over a final rise and the light changed: not brighter, different in source, the grey-blue of open water carrying a quality the interior sky had not had. The smell changed with it. Salt. The sound changed too: wind off open water instead of flat interior air.
...
The engagement was coastal geometry. The drones were spread wide with no overhead cover, their positions calibrated for open ground and a long approach. I held the path margin above the shelf while the team worked the waterline. Maria operated differently at the water: the casual register entirely gone, her ship working the current with a precision none of us had seen from her in any interior engagement. When it was over she stopped.
...
"You didn't use the aft mount once."

"I did not lead with it. It still fires. It just does not seat right when it does, so I have been asking cover to do more of the work since the tideline." She did not look at either of them when she said it. "You have simply never had reason to watch closely enough to notice."

"Logged." A pause. "You did not file a repair request for it. Not after the tideline, and not after the relay village. That is two opportunities."

"I am aware of the count, Katyusha."

She was not going to fix it. Watching her, I understood she had decided that a while ago, and simply had not said so until now.

Maria resettled her hat, then looked at the building.
...
None of the other drawers stood open. She had not searched: she had crossed a building of a hundred drawers to the one cabinet and pulled the one folder. I filed it with the rest of the knowing this island refused to explain.
...
She went through the door. Katyusha moved to the waterline position, Nadeshiko covered the building from above, and I stayed at the cabinet with the open folder, the second ink still on the page in front of me.

She came back in three minutes with the remaining files, did not read them here, and put them in her jacket with the notebook without saying anything more about it.
...
His estimate for the waterfront building had been half a day. They had cleared it in less than two hours. I noted the variance, sent it, and moved west.
...
A courtyard pond ran the center of the approach, bridged in two places, and Maria crossed it without using either bridge. The combined archive was the most fortified position we had encountered since the Nest: four corner towers, drone stacks inside holding a specific position at the interior.
...
"This building has the assessment of what we were built for." I looked at the tower positions and the coverage: the most heavily guarded position in the testing grounds. "That is the clearest read we will get."

Katyusha: "Or whoever set up the defense did not want it found."

We pushed the perimeter. I held the approach road while the team worked the corner towers, then the stacks inside. Drones held the central table in stack formation, not residual patrol: they were protecting a specific record, not a room. We cleared through.

Nadeshiko reached the central table first. She opened the top binder and read without speaking long enough that the others noticed, then set it down, then picked it up again.
...
There had been pressure to expand the scope. I had been present when it was applied, and had agreed to it. The memory arrived accurate and sourceless: I had known what these buildings contained, and had kept building anyway.
...
The withdrawal corridor was wide and low, built for tracked loads rather than people on foot, and Nadeshiko moved through it with the originals pressed close.
