...
The light went before the road did, three streets past the civic offices, and Maria called the stop before I had to. My legs had been telling me for an hour that walking was no longer the same activity it had been that morning, and I had been ignoring them the way I ignored most reports that did not change what came next. A municipal annex sat off the avenue with its ground floor mostly intact: a security checkpoint just inside the entrance, glass gone from the frame but the desk still standing, a faded lane marking on the floor for a queue that had stopped forming years before anyone stopped painting the lines back in. Behind it, a conference room built for people who needed a long table and did not expect to be interrupted. A retracted screen on one wall, a projector mount above it with nothing in it. One window, facing a residential street that had nothing left in it to face, and below it a forecourt reflecting pool gone still and black, the kind of civic flourish that had once made the building look more important than a permit office needed to look. Maria had already circled it once from the outside before she called the stop. Katyusha checked the corners out of habit and found nothing that needed checking, and said so, and checked them again.

We laid the files out in the order she had reconstructed them in the archive: the committee run, the attendance sheets, the two objections, the memo with the pencil on its back. I sorted them further into three stacks, procedure and objection and outcome. The paper was cool and slightly damp at the edges, the particular texture of things that had spent two years in a basement and one evening in the open air. Nobody sat. The chairs were still pushed in around the table, waiting for people who were not coming back to a meeting that had already happened.
...
The drones found us before anyone could sit with that for long. They came in off the side corridors fast and did not hold, three then five then more, herding rather than blocking, the kind of pressure built to move a target rather than stop it.
...
I have heard that shape before. Not the words. The click a fact makes when it lands somewhere it already fits. I know exactly where I heard it and exactly why I am not saying so, and neither of those is new information tonight. What is new is how much I wanted, for about half a second, right there in the corridor, to just hand the doctor the whole thing at once instead of the pieces I have been rationing her since the relay.
...
By the time the last servo wound down instead of just stopping, I had already decided, again, that tonight was not the night. It is the same decision every time. It has never once gotten easier to hear myself make it.
...
Two documents shared the folder. On the left, committee minutes: item three, the team's own filed request to hold the accelerated field deployment timeline until certification validation caught up with it. The same objection Katyusha had already read to us from the archive attendance sheets, given its own line in a different session's record. *Request denied. Reason: operational timeline constraints.* A note in the margin, in my own hand, small and even in the way my writing gets when I already know how something will end. *I knew it would be denied. I filed it so there would be a record.*

On the right, something that was not minutes at all. An instrument of agreement, the kind of document built to be read by lawyers and nobody else. Oracle's architecture, its data, its physical installation, to transfer to the Nautilus Empire's defense authority upon project completion, in exchange for the Panzer Republic's protected status as a client state. A signature at the bottom, close and unhurried: Commandant Reiss. A date stamped beside it that I read twice, the reflex I used to pretend I did not have.

The date sat six months before the catastrophe. Before my safety report. Before the first objection I had ever filed against anything Oracle was doing. The agreement had existed before I had known enough to be against anything, and no one at the research table it governed had ever been told it existed at all.
...
I did not press her. Whatever she was still deciding whether to hand over, she had been deciding it since before I knew her name meant anything to her, and two more streets of walking was not going to change the shape of that decision.


We stepped out through the checkpoint's blown frame into full dark, the residential street giving onto an open square somewhere past the next block, civic ground by the look of the lamp posts still standing over it in a long unbroken row, and a flagpole at the near edge with nothing flying from it. No snow yet. The cold had a different quality out here than it had in the conference room, less a temperature than a kind of attention.
