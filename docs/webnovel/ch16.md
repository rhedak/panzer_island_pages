...
The corridor from the vault ran northeast through the facility's upper level. The floor changed at the second junction: lab concrete giving way to carpet, grey-brown and worn flat by years of administrative traffic, the light warmer than the vault's emergency strips, the smell shifting to processed air and paper, the flatness of a space built for records rather than equipment.

A conference room sat at the center, pending trays on the back desks, a coffee station against the south wall with one ring mark on the shelf below the machine, worn deep from years of the same cup in the same spot. The lab and the vault had held what was built. This was where it had been authorized.

Katyusha had gone ahead to the second workstation. She did not touch anything; she read from six centimeters back.

"She has been working from here. The terminal is warm. The chair height is hers."

She had been here while we were still in the vault.

"She has been reading what we are about to read."

"Yes."

Katyusha was already at the doorway.

"She knows what the pending tray contains. We have not read it."
...
The flag was slightly faded, the red gone dull at the edges, but the adhesive held. The document had been sitting in that tray for two years, waiting on an answer that never came, before the catastrophe or after.
...
I reached for the folder and my hands went straight to the flagged tab before I had read the author line, and I freed it from the tray.
...
The body of the report was twelve pages. Initiative weight failure modes, cascade propagation rates under three modeled deployment scenarios. The methodology was familiar before I could name why. The margin annotations were mine before I had finished reading the first one. The section on the Phase 4 scaffold was two full pages, the argument precise and technical: the kind of argument written by someone who had believed the committee would extend the timeline if the case was complete.
...
I closed the folder. Maria stood at the doorway, watching the angle back to the corridor.
...
I crossed to the desk. I had seen the second document from the doorway, its corner visible under the assessment the whole time Erika read. I reached past the assessment and came out with it. I read it once, then again: the same document I had been carrying in the part of my memory that had not been asked to forget anything.
...
Two documents in the same tray. One recommendation, precisely argued, twelve pages. One override, four sentences, no name required. I looked at both of them: a committee had reviewed the full argument and approved the override.
...
Parked out of the way, protected, or removed from the board: the difference between those two was the whole question, and she had handed me exactly enough to know the question existed.
...
The loading corridor was wide and low, built for tracked loads rather than foot traffic. We stopped at the threshold. Wilhelm had placed every room in the order we had read them: the ranges, the archive, the hub, the testing grounds, the connector building, the vault, this building, floor by floor. The last section was ahead. The folder was in my hands.
