...
Past the range and the berm country, the terrain opened. Ground cover thinned, and the range markers changed: longer stakes, wider intervals, oriented along corridors instead of across impact zones. These measured approach paths, not blast radius.
...
I had heard something close to that before, from my own mouth.
...
Katyusha: "File it. We push on."

Nadeshiko peeled ahead to read the corridor.
...
The range cleared without difficulty. The drone deployment was thinner here than at the firing range. Drona was moving the team through, not slowing it.
...
The control booth observation window faced east across the full length of the flight range. The terminal was mounted beside the window, its screen already on.
...
She read without speaking. The records were thorough: performance metrics, scenario logs, accuracy and efficiency tables across multiple series, each logged to within tight margins. The researcher notes were in my handwriting: I recognized the shorthand, the way I flagged outliers.
...
Below the recommendation sat a note in a different hand, shorter, underlined once.
...
The counter-annotation was in the same handwriting as the notes I had seen in Katyusha's trial logs: dense, short, a different pen weight than mine, the same argument held consistently across both unit series. I had been making this case in writing, in margins I no longer remembered writing in, and it was still there.

I set the pad down.

The route from the flight range to the command hub ran along a hard-packed access road through the eastern testing sector, the hub visible ahead, wider than the individual ranges. Maria peeled off toward the cooling reservoir at its south corner without a word and met us again at the hub doors, having covered the same distance without touching the road once.
...
The hub doors were open. Katyusha had read the building from the approach without consulting a plan: she described its purpose before we entered, the way it was designed to correlate data from every range simultaneously rather than process it in isolation. I told her this was the one building I wanted to read with her, not after her. She acknowledged.

The deployment inside was denser than patrol shape, each position chosen rather than distributed.
...
The hub's operational floor held a master timeline board on the north wall: horizontal bars in unit colors, KAT / NAD / MAR, years of measurement reduced to a wall you could read in a minute. A fourth bar ran the full length alongside the other three.
...
Nobody spoke to it. We had all looked.

Katyusha found the session archive on the mezzanine: a fire cabinet, rated to survive anything the building could do to it, standing open. The folders inside were intact through the final quarter. The last folder was ash.
...
Outside the hub, the testing sector spread behind us, the main facility ahead, larger than it had looked from the archive. The late light was flatter here, no cover to cast shadow.
...
Beyond the hub the approach road curved south, and the terrain shifted again: a broader exposure than the flat channel of the flight range, and the light had a quality I recognized before I could account for it, the marine layer diffusing differently over water.

Maria went quiet, not the pause she used for emphasis but something prior to that.

"There is water."

Nadeshiko: "Oh, she noticed."

Maria did not take the opening. She was looking south between the range structures at the water visible in the distance.
